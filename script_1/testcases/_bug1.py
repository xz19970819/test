...
class TestCase(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        s = Service("D:\B_python\driver\chromedriver.exe")
...
# 测试用例3
    def test_bug_solve(self):
        '''解决bug'''
        sleep(2)
        self.driver.find_element(By.LINK_TEXT, "测试").click()  #点击测试按钮
        sleep(2)
        self.driver.find_element(By.XPATH, "//header/div[@id='subHeader']/div[1]/nav[1]/ul[1]/li[1]/a[1]").click()   #点击bug按钮
        self.driver.find_element(By.XPATH,"//tbody/tr[1]/td[11]/a[2]/i[1]").click()  #点击解决按钮
        sleep(2)
